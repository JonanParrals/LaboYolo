...
object ImageUtils {
    /** Convierte un ImageProxy (formato YUV_420_888) de CameraX a un Bitmap ARGB_8888. */
    ...
    /** Redimensiona con "letterbox" (mantiene aspect ratio, rellena con negro) a targetSize x targetSize. */
    fun letterbox(src: Bitmap, targetSize: Int): Bitmap {
